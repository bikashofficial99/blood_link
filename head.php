...
img.logo2{
  width:124px; height:134px; float:left; display:inline-block;
}
</style>
</head>
...
<body>
  <div class="header">
    <a href="dashboard.php" class="logo"<?php if($active=='home') echo "class='logo2'"; ?>><img src="image\Logo final222.png" style="width:100px; height:100px; float:left; display:inline-block;" > </a><br><br>
    ...
    <a href="why_donate_blood.php"  <?php if($active=='why') echo "class='act'"; ?>>Why Donate Blood</a>
      ...
      <a href="logout.php" <?php if($active=='logout') echo "class='act'"; ?>>Log Out</a>
    </div>
  </div>
